...
export const EcommerceTemplate = ({
  ...
  const header = (
    <div className={`py-4 glass sticky top-0 z-50 ${headerClassName}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-background/70 text-lg leading-relaxed max-w-md">
              Future objects. Minimal design. Maximum impact.
            </p>
          </div>

          {/* Links */}
          <div>
            <h3 className="font-semibold mb-4 text-background uppercase tracking-wider text-sm">Navigate</h3>
          ...
          {/* Social Links */}
          <div>
            <h3 className="font-semibold mb-4 text-background uppercase tracking-wider text-sm">Connect</h3>
            <SocialLinks />
          </div>
        </div>
